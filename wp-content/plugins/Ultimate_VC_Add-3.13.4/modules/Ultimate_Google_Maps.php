...
if(!class_exists("Ultimate_Google_Maps")){
	class Ultimate_Google_Maps{
		...
		{
			wp_register_script("googleapis","https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&key=AIzaSyD2v0ROOS-H0xff7ozK6DWSDdW4RSaTj4M",array(),ULTIMATE_VERSION,false);
