...
Description: Excitel helps your customers make calls from your site over Internet (free) using WebRTC, RTMP and SIP protocols.
Version: 1.3
Author: Excitel
Author URI: https://excitel.net/
Text Domain: excitel-click-to-call
Domain Path: languages/
*/

/*  Copyright 2014-2016  Excitel  (email : support {at} excitel.net)
