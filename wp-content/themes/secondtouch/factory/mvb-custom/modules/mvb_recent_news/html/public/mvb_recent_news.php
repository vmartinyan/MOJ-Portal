...
<?php
if ( isset( $enable_autoscroll ) && ( $enable_autoscroll == '1' ) ) {
	$scroll = 'true';
} else {
	$scroll = 'false';
}

if ( isset( $autoscroll_speed ) && ! ( $autoscroll_speed == '' ) ) {
	$scroll_speed = $autoscroll_speed . '000';
} else {
	$scroll_speed = '3000';
}
?>
...
<script type="text/javascript">
	jQuery(document).ready(function () {
		...
		jQuery('#<?php echo $unique_id ?>').flexslider({
			...
			slideshow: <?php echo $scroll;?>,
			slideshowSpeed:<?php echo $scroll_speed;?>,
