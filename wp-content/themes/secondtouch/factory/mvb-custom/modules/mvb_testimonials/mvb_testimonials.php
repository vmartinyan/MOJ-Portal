...
class MVB_Testimonials
{
    ...
    public static function fields()
    {
        ...
        $the_fields = array(
            ...
            'module_style' => array(
	            'type'      =>      'select',
	            'label'     =>      __('Module style', 'mvb'),
	            'help'      =>      __('Style of block (slider or list)', 'mvb'),
	            'default'   =>      0,
	            'options'   =>      array(
		            0 => esc_html__('Slider','mvb'),
		            1 => esc_html__('List','mvb'),
	            ),
	            'col_span'  =>      'lbl_third'
            ),
			...
			'autoslideshow' => array(
				...
				'help'      =>      __('Enable or disable auto scrolling of blocks(for slider style only)', 'mvb'),
				'default'   =>      0,
				'options'   =>      mvb_yes_no(),
				'col_span'  =>      'lbl_third'
			),
