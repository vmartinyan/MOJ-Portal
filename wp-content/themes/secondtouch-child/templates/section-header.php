<?php $options = get_option('second-touch'); ?> <?php $sticky = $options['fixed_menu_show'] == '1'; $meta_sticky = get_post_meta( get_the_ID(), 'crum_sticky_menu', true ); if ( isset( $meta_sticky ) && ! empty( $meta_sticky ) && 
! ( 'default' === $meta_sticky ) ) {
	if ( 'yes' === $meta_sticky ) {
		$sticky = '1';
...
$mobile_menu_style = ''; $mobile_hide = ''; if(isset($options['mobile_menu_show']) && ('1' === $options['mobile_menu_show'])){
...
?> <section id="header" class="horizontal" data-not-fixed="<?php echo $fixed;?>">
            ...
            <div class="twelve columns">
                ...
                if (isset($options['custom_logo_image']['url']) && !empty($options['custom_logo_image']['url'])) { ?>
                    <div id="logo">
						...
						<a href="<?php echo home_url(); ?>/"><img src="<?php echo site_url(); ?>/wp-content/uploads/2013/03/<?php echo __('[:hy]logo-baner.png[:en]logo-baner-en.png[:ru]logo-baner-ru.png[:]');?>" width="359" alt="<?php bloginfo('name'); ?>"></a>
                        <a href="<?php echo home_url(); ?>/"><img class="for-panel" src="<?php echo site_url(); ?>/wp-content/uploads/2013/03/<?php echo __('[:hy]logo-baner.png[:en]logo-baner-en.png[:ru]logo-baner-ru.png[:]');?>" alt="<?php bloginfo('name'); ?>"></a>
                    </div>
    ...
    </div> </section> <section id="before-content-block">
	<?php crum_shortcode_before();?> </section>
